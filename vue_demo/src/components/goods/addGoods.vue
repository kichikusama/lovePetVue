      ...
      <div style="padding:20px">
        ...
        <el-form-item label="商品口味" prop="taste">
          <el-radio-group v-model="goods.goodsTaste">
            <el-radio-button label="鸡肉味"></el-radio-button>
            <el-radio-button label="牛肉味"></el-radio-button>
            <el-radio-button label="其他"></el-radio-button>
            <el-radio-button label="无"></el-radio-button>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="特殊功能" prop="special">
          <el-input v-model="goods.goodsSpecial" clearable></el-input>
        </el-form-item>
      </div>
      <div style="padding:20px">
